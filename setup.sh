...
wget https://raw.githubusercontent.com/scriptvpskita/xray-learning/main/setup-sshvpn.sh && chmod +x setup-sshvpn.sh && ./setup-sshvpn.sh
wget https://raw.githubusercontent.com/scriptvpskita/xray-learning/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
wget https://raw.githubusercontent.com/scriptvpskita/xray-learning/main/ssh-ws-ssl.sh && chmod +x ssh-ws-ssl.sh && ./ssh-ws-sssl.sh
cd /usr/bin
